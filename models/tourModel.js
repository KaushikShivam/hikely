...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      minlength: [10, 'A tour must have a name more than 40 characters']
      // validate: [validator.isAlpha, 'A tourname must only contain characters']
    },
    slug: String,
    duration: {
      type: Number,
    ...
    priceDiscount: {
      type: Number,
      validate: {
        // Only works on newly created documents
